...
Depends: apache2
Recommends: apache2-suexec-custom, bind9, clamav, clamav-base, clamav-daemon, clamav-docs, clamav-freshclam, clamav-testfiles, dovecot-core, dovecot-imapd, dovecot-pop3d, jailkit, libapache2-mod-fcgid, libsasl2-2, libsasl2-modules, milter-greylist, opendkim, php-imap, postfix, postfix-pcre, postgrey, procmail, procmail-wrapper, proftpd-basic, proftpd-mod-crypto, sasl2-bin, spamassassin, spamc, webmin-jailkit
Architecture: all
